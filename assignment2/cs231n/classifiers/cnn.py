...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2']=np.random.normal(scale=weight_scale,size=(F*Ho*Wo,hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        loss=loss+0.5*self.reg*((self.params['W1']**2).sum()+(self.params['W2']**2).sum()+(self.params['W3']**2).sum())
        dout2,grads['W3'],grads['b3']=affine_backward(grads_scores,cache3)
